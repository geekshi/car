...
/* Keil::Device:StdPeriph Drivers:CEC:3.5.0 */
#define RTE_DEVICE_STDPERIPH_CEC
/* Keil::Device:StdPeriph Drivers:CRC:3.5.0 */
#define RTE_DEVICE_STDPERIPH_CRC
/* Keil::Device:StdPeriph Drivers:DAC:3.5.0 */
...
/* Keil::Device:StdPeriph Drivers:FSMC:3.5.0 */
...
/* Keil::Device:StdPeriph Drivers:SDIO:3.5.0 */
...
/* Keil::Device:StdPeriph Drivers:WWDG:3.5.0 */
